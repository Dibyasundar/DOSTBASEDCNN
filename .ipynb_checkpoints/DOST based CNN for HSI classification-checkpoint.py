...
def classifier(X,y,numComponents = 64, windowSize =7,testRatio = 0.95,dost_ = True,wls_alpha=1.0,wls_lambda=1.0):
...
#        print(model.summary(),file = report)
        ...
        filepath = "../models/conv_{}_{}_{}_{}_{}_{}.h5".format(numComponents,windowSize,testRatio,dost_,wls_alpha,wls_lambda)
        print(filepath)
...
if __name__ == "__main__":
    ...
    classifier(X,y,numComponents = 64, windowSize =7,testRatio = 0.95,dost_ = True,wls_alpha=1.2,wls_lambda=0.8)
